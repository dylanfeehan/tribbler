...
src/github.com/dylanfeehan/tribbler/
...
```bash
go install github.com/dylanfeehan/tribbler/runners/srunner
go install github.com/dylanfeehan/tribbler/runners/lrunner
go install github.com/dylanfeehan/tribbler/runners/trunner
go install github.com/dylanfeehan/tribbler/runners/crunner
```
...
`p2/src/github.com/dylanfeehan/tribbler/runners/` directory and may be executed from anywhere on your system.
...
code located in the `p2/src/github.com/dylanfeehan/tribbler/tests/` directory. What's more, a few of these tests
...
Then, navigate to [localhost:6060/pkg/github.com/dylanfeehan/tribbler](http://localhost:6060/pkg/github.com/dylanfeehan/tribbler)
